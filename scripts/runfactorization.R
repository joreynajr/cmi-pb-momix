...
#    #unlink(temp.folder, recursive=T)
    ...
    ##### RGCCA 
    print("##### RGCCA #####")
    factorizations_RGCCA <- rgcca(lapply(omics, function(x) t(x)),
                              ncomp = rep(num.factors, length(omics)),
                              scheme = "centroid",
                              scale = TRUE,
                              init = "svd",
                              bias = TRUE,
  ...
  # ##### MOFA (removed due to installation difficulties)
  # print("##### MOFA #####")
  ...
  # ##### tICA (removed due to installation difficulties)
  # print("##### tICA #####")
  #   omics_tensor<-list()
  #   for(j in 1:length(omics)){
